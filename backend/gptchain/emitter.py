...
from gptchain.client.base import MessageDict
from gptchain.data import gptchain_client
from gptchain.element import Element
from gptchain.message import Message
from gptchain.session import BaseSession, WebsocketSession
from gptchain.types import AskSpec, UIMessagePayload
from socketio.exceptions import TimeoutError


class BasegptchainEmitter:
    """
    gptchain Emitter Stub class. This class is used for testing purposes.
    It stubs the gptchainEmitter class and does nothing on function calls.
    """
...
class gptchainEmitter(BasegptchainEmitter):
    """
    gptchain Emitter class. The Emitter is not directly exposed to the developer.
