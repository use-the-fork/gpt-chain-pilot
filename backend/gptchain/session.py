...
if TYPE_CHECKING:
    ...
    from gptchain.types import AskResponse
    ...
    async def get_conversation_id(self) -> Optional[str]:
        ...
        async with self.lock:
            if not self.conversation_id:
                ...
                self.conversation_id = await gptchain_client.create_conversation(
...
class HTTPSession(BaseSession):
    """Internal HTTP session object. Used to consume gptchain through API (no websocket)."""
