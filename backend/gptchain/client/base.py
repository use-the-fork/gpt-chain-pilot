...
class gptchainGraphQLClient:
    def __init__(self, api_key: str, gptchain_server: str):
        self.headers = {"content-type": "application/json"}
        if api_key:
            self.headers["x-api-key"] = api_key
        else:
            raise ValueError("Cannot instantiate Cloud Client without gptchain_API_KEY")

        graphql_endpoint = f"{gptchain_server}/api/graphql"
