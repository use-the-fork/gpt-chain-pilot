...
class gptchainCloudClient(gptchainGraphQLClient):
    gptchain_server: str

    def __init__(self, api_key: str, gptchain_server="https://cloud.gptchain.io"):
        # Remove trailing slash
        gptchain_server = gptchain_server.rstrip("/")
        super().__init__(api_key=api_key, gptchain_server=gptchain_server)
        self.gptchain_server = gptchain_server
