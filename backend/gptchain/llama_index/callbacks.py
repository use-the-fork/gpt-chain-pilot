...
from gptchain.element import Text
...
class LlamaIndexCallbackHandler(BaseCallbackHandler):
    ...
    def _restore_context(self) -> None:
        """Restore gptchain context in the current thread

        gptchain context is local to the main thread, and LlamaIndex
        runs the callbacks in its own threads, so they don't have a
        gptchain context by default.
